        ...
        <div class="form-container">
            <form id="frmProduto" method="POST" enctype='multipart/form-data'
                ...
                <div class="input-wrapper">
                    ...
                    <input name="file[]" type="file" id="fileComprovante">
                </div>
                
                <div class="input-wrapper">
                    <label for="txtDescricao">Descrição:</label>
                    <textarea type="text" id="txtDescricao" name="descricao" maxlength="1000" placeholder="Descreva o problema com o produto." rows="15"></textarea>
                </div>
                <input type="hidden" id="hddIdPedido" value="<?=$dados["id"]?>">
